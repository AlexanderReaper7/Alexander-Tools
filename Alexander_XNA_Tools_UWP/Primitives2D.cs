...
namespace Alexander_XNA_Tools_UWP
{
    ...
    public static class Primitives2D
    {
        ...
        /// </summary>
        /// <param name="spriteBatch">The destination drawing surface</param>
        /// <param name="squaresX">The number of squares in X-axis</param>
        /// <param name="squaresY">The number of squares in Y-axis</param>
        /// <param name="squareSize">The length of the side of each square</param>
        /// <param name="thickness">The thickness of the lines used</param>
        public static void DrawGrid(this SpriteBatch spriteBatch, int squaresX, int squaresY, float squareSize, float margin, Color color, float thickness = 1.0f)
        {
            // 
            ...
            {
                float x = squareSize * i + margin;
                spriteBatch.DrawLine(x, margin, x, bottom, color, thickness);
            }

            // Draw horizontal lines
            for (int i = 0; i < squaresY; i++)
            {
                float y = squareSize * i + margin;
                spriteBatch.DrawLine(margin, y, right, y, color, thickness);
            }
        }
